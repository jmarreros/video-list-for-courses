  ...
  <form method="post" action="options.php">
    ...
    <table class="form-table">
      ...
      <?php
        ...
        // Show input url
        // $title =  __( 'Base page', 'video-list-for-courses' );
        // $subtitle = __( 'Page url base to autocomplete url path in courses list', 'video-list-for-courses' );
        // $key = 'base_url';
        // create_input_setting_row( $title, $subtitle, $key, $vlfc_options )
...
//   function create_input_setting_row( $title, $subtitle, $key, $vlfc_options){
//     $val = '';
//     if ( isset($vlfc_options[$key]) ) {
//       $val = $vlfc_options[$key];
//     }
//     echo '
//     <tr valign="top">
//     <th scope="row">'.$title.'</th>
...
//         <legend class="screen-reader-text"><span>'.$title .'</span></legend>
//         <label for="'.$key.'">
//           <input type="text" id="'.$key.'" name="vlfc_options['.$key.']" value="'. $val .'"/>
//           <span>'.$subtitle.'</span>
//         </label>
